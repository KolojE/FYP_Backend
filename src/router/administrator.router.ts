...
import { addFormController, deleteFormController, deleteMemberController, getReportController, getReportElement, updateFormController, updateMemberActivationController,  viewMembersController } from "../controller/administrator.controller";
